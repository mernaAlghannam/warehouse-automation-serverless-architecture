...
$newapikey = az functionapp function keys set -g warehouse-automation_group -n shipping-data-api --function-name get-shipping-data --key-name default | Out-String | ConvertFrom-Json 

$newapikey = $newapikey.value
az account set --subscription 222777e5-63af-4bcd-9b37-938e8cd5b92e
